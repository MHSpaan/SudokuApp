            ...
            while (!solved)
            {
                do
                {
                    ...
                    for (int j = 1; j <= size; j++)
                    {
                        ...
                        uc.FillArray1Option(sn, sudokuarray,1);

                        counter += pc.CountPossibilities(sn.Possibilitiesarray.Values);

                        //vc.ConsoleSudokuDisplay(PossibilityArrayValues);
                        //Console.ReadLine();
                    }
                    sl.UpdateValues(sudokuarray);
                    if (counter == 0)
                ...
                if (counter != 0)
                {
                    ...
                    vc.ConsoleSudokuDisplay(sudokuarray);
                    Console.ReadLine();
                    PossibilityArrayValues = uc.FillArray2Options(sn, sudokuarray, 2);
